...
// Methods
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        strokeWidthSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar strokeWidthSeekBar, int progress,
                    boolean fromUser) {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.exportId:
                ...
                exportDialogue
                        .setItems(fileFormatsSelection, new DialogInterface.OnClickListener() {
                            @Override
                            public void onClick(DialogInterface dialog, int which) {
                                switch (which) {
                                    case 0:
                                        try {
                                            if (canvasView.export(MainActivity.this, "JPEG")
                                                    == true) {
                                    ...
                                    case 1:
                                        try {
                                            if (canvasView.export(MainActivity.this, "PNG")
                                                    == true) {
            ...
            case R.id.newCombiShapeId:
                ...
                mainActivityViewModel.enableCombinedShapesMode(
                        (CombinedShape) canvasView.getSelectedGraphicalElement());
    ...
    public void onSaveCombinedShape(View view) {
        try {
            ...
            showToast("New Combined Shape saved: " + combinedShape.getName() + " (" + combinedShape

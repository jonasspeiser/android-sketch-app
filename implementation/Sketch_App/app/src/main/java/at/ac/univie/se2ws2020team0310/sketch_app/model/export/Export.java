...
public abstract class Export {
    ...
    public abstract void compressImage(Bitmap drawingCache, String fileFormat)
            throws IOException;

    public void exportingImage(String fileFormat, Context context) throws IOException {
        this.out.close();
